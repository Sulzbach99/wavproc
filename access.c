...
{
    AUDIO->ChunkID = malloc(AudNum * sizeof(char*));
    AUDIO->ChunkSize = malloc(AudNum * sizeof(int));
    AUDIO->Format = malloc(AudNum * sizeof(char*));
    AUDIO->SubChunk1ID = malloc(AudNum * sizeof(char*));
    AUDIO->SubChunk1Size = malloc(AudNum * sizeof(int));
    AUDIO->AudioFormat = malloc(AudNum * sizeof(short));
    AUDIO->ChannelNr = malloc(AudNum * sizeof(short));
    AUDIO->SampleRate = malloc(AudNum * sizeof(int));
    AUDIO->ByteRate = malloc(AudNum * sizeof(int));
    AUDIO->BlockAlign = malloc(AudNum * sizeof(short));
    AUDIO->BitsPerSample = malloc(AudNum * sizeof(short));
    AUDIO->SubChunk2ID = malloc(AudNum * sizeof(char*));
    AUDIO->SubChunk2Size = malloc(AudNum * sizeof(int));
